...
public record DrawMarkPacket(Mark mark, BlockPos markBlockPos, InteractionHand drawingHand) {
    public static DrawMarkPacket fromBuffer(FriendlyByteBuf buffer) {
        return new DrawMarkPacket(
